...
- [ ] 1. заполняй тестовыми резюме RESUME_1/2/3
- [ ] 2. проверку размера полученного массива верни как было
- saveOverflow
- [ ] 1. перед блоком try очищай хранилище
- [ ] 2. System.out.println("Fill storage"); - удали этот вывод
- [ ] 3. storage.clear(); это в пункте 1 нужно
- [ ] 4. Assert.fai l("ИНФОРМАТИВНОЕ СООБЩЕНИЕ ЗДЕСЬ ВЫВОДИТЬ");
