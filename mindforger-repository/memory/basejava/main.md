...
File - абстракция, которая по пути связана с файлом,  
которого может не быть в начале.  

Очень многие File бросают IOException  
который checked - старый класс - Java 1.1

Пока просто пробросим - throw на psvm  
